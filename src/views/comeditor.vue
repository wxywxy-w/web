...
<script>
	...
	export default {
		...
		data() {
          ...
          console.log("初始数据")
          console.log(infoGet);
          let showInfo=this.$store.state.Medium;
          console.log("vuex成功数据")
          console.log(showInfo)
			return {
                info: infoGet, //保存数据显示
				imgUrl:'http://49.234.229.202:7088/backstage/upload/auth/uploadOSS',
				// model6: '3',//0:自营 1：拼多多 2：淘宝 //3自营
				model6: showInfo.platformType,//0:自营 1：拼多多 2：淘宝 //3自营
                // goodsTitle:'',//商品标题
                goodsTitle:showInfo.goodsName,//商品标题
                // mountValue:'0',//库存数量
                mountValue:showInfo.stock,//库存数量
                yuanValue:showInfo.minNormalPrice,//原价
                zheValue:showInfo.minGroupPrice,//折扣价/最小优惠价
                buValue:showInfo.promotionRate,//补贴金额/佣金比例
                //已上传图片
				defaultList: [],
				uploadList: [],
				Goodscopy:showInfo.goodsDesc,//商品文案
				editor: {
					info: ''
                },
                gfshow:false,
