    ...
    <div>
      <Card style="width:100%;margin-top:23px" :bordered="false" class="contentlist">
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
          ...
          <FormItem label="商品ID" prop="name">
            <Input v-model="formValidate.name" placeholder="请输入商品ID"></Input>
          </FormItem>
          <FormItem label="内容文案" prop="name">
            <Input v-model="value6" type="textarea" :rows="4" placeholder="请输入合适的商品文案" />
          </FormItem>

          <FormItem label="宣传图片" prop="name">
...
export default {
  ...
  mounted() {
    ...
    this.axios
      .post("/backstage/auth/addCustomizeGoods", {})
      .then(data => {
        //原来的请求
